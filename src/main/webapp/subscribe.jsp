...
<body>
	...
	<section class="slice slice-lg bg-image"
		style="background-image:url(<c:url value="/full-bg-6.jpg"/>); height:400px">
		<div class="wp-section">
			<div class="container" style="position: center; height: 250px">
				<form action="subscribe" method="post">
					<div class="row">
						<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-5">
							<div class="wp-block default user-form user-form-alpha ">
						...
						<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-5">
							<span class="input-group-btn">
								...
								<button value="Subscribe"
									class="btn btn-base btn-icon btn-icon-right pull-right"
									type="submit">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					<div class="col">
						<h4>Movie Motto</h4>
						<p>		Live fast, die young, leave a good looking corpse.</p>
								<span>Nick Romano -- Knock On Any Door</span>
