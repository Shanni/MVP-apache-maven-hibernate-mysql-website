    ...
    <div id="divHeaderWrapper">
        ...
        <section id="slider-wrapper" class="layer-slider-wrapper layer-slider-dynamic">
            <div id="layerslider" style="width:100%;height:520px;">
                ...
                <div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;">
                    <!-- slide background -->
                    <img src="http://www.hdwallpapers.in/walls/2010_inception_movie-wide.jpg" class="ls-bg" alt="Slide background"/>
                ...
                <div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;">
                    <!-- slide background -->
                    <img src="http://upload.wikimedia.org/wikipedia/commons/f/f4/MovieTheatre_gobeirne.jpg" class="ls-bg" style="width: 100%;" alt="Slide background"/>
                    
                    <!-- Left Text -->
                    <h3 class="ls-l title text-normal" style="width:600px; top:35%; left:80px;color:white;" data-ls="offsetxin:0;offsetyin:250;durationin:1000;delayin:500;offsetxout:0;offsetyout:-8;easingout:easeInOutQuart;scalexout:1.2;scaleyout:1.2;">
                    Watch movie from here... <span class="strong-600" >you</span> <span class="strong-600 c-base">get started</span></strong>
                    </h3>
                    <p class="ls-l text-standard" style="width:500px; top:50%; left:80px; color:white" data-ls="offsetxin:0;offsetyin:250;durationin:1000;delayin:1000;offsetxout:0;offsetyout:-8;easingout:easeInOutQuart;scalexout:1.2;scaleyout:1.2;">
                    Gingko is the best movie searching engine in the world
                    </p>
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="sort-list-btn hidden-xs">
                                            ...
                                            <button type="button" class="btn btn-white filter" data-filter="category_1 category_2 category_3">Action</button>
                                            <button type="button" class="btn btn-white filter" data-filter="category_3 category_5 category_6 category_7 category_8">Adventure</button>
                                            <button type="button" class="btn btn-white filter" data-filter="category_6 category_7 category_8">Horror</button>
                                            <button type="button" class="btn btn-white filter" data-filter="category_3">New</button>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="btn-group pull-right hidden-md hidden-lg">
                                            ...
                                            <ul class="dropdown-menu pull-right" role="menu" id="ulFilterMenu">
                                                ...
                                                <li class="filter" data-filter="category_1 category_2 category_3"><a>Action</a></li>
                                                <li class="filter" data-filter="category_3 category_5 category_6 category_7 category_8"><a>Adventure</a></li>
                                                <li class="filter" data-filter="category_6 category_7 category_8"><a>Horror</a></li>
                            ...
                            <div class="row">
                                <div id="ulSorList" style="margin:15px 15px;">
                                    <div class="mix category_1 mix_all" data-cat="1">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="<c:url value="/resources/images/prv/new1.jpg"/> alt="" class="img-responsive">
                                    ...
                                    <div class="mix category_2 mix_all" data-cat="2">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="<c:url value="/resources/images/prv/new2.jpg"/>" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque
                                    ...
                                    <div class="mix category_3 mix_all" data-cat="3">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="<c:url value="/resources/images/prv/new3.jpg"/>" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque
                                    ...
                                    <div class="mix category_4 mix_all" data-cat="4">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="<c:url value="/resources/images/prv/new4.jpg"/>" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque
                                    ...
                                    <div class="mix category_5 mix_all" data-cat="5">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="<c:url value="/resources/images/prv/new5.jpg"/>" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque
                                    ...
                                    <div class="mix category_6 mix_all" data-cat="6">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="<c:url value="/resources/images/prv/new6.jpg"/>" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque
                                    ...
                                    <div class="mix category_7 mix_all" data-cat="7">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="<c:url value="/resources/images/prv/new7.jpg"/>" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque
                                    ...
                                    <div class="mix category_8 mix_all" data-cat="8">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="<c:url value="/resources/images/prv/new8.jpg"/>" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque
                                    ...
                                    <div class="mix category_9 mix_all" data-cat="9">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="<c:url value="/resources/images/prv/new9.jpg"/>" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque
                                    ...
                                    <div class="mix category_10 mix_all" data-cat="10">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="<c:url value="/resources/images/prv/wk-big-img-2.jpg"/>" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque
                                    ...
                                    <div class="mix category_11 mix_all" data-cat="11">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="<c:url value="/resources/images/prv/wk-big-img-3.jpg"/>" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque
                                    ...
                                    <div class="mix category_12 mix_all" data-cat="12">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="<c:url value="/resources/images/prv/wk-big-img-4.jpg"/>" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque
                                ...
                                <div class="row">
                                        ...
                                        <div id="homepageCarousel" class="carousel carousel-1 slide" data-ride="carousel">
                                            <div class="carousel-inner">
                                                ...
                                                <div class="item item-dark active">
                                                    <img src="<c:url value="/resources/images/prv/magazine/magazine-4.jpg"/>" alt="">
                                                    <!-- Carousel caption -->
                                                ...
                                                <div class="item item-light">
                                                    <img src="<c:url value="/resources/images/prv/magazine/magazine-2.jpg"/>" alt="" class="img-responsive">
                                                    <!-- Carousel caption -->
                                                    <div class="caption-bottom">
                                                        <span class="title c-white">The new Boomerang 2 MultiPuropose Website Template</span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="wp-block mb-20">
                                            <img src="<c:url value="/resources/images/prv/magazine/magazine-small-5.jpg"/>" class="img-responsive" alt="">
                                            <!-- Caption -->
                                            <div class="caption-bottom">
                                                <span class="title c-white">God is an awesome mathematician and physicist</span>
                                                <span class="subtitle c-white">Laoreet dolore magna aliquam erat are esrseiiqetuer ipisci.</span>
                                            </div>
                                        </div>
                                        <div class="wp-block no-margin">
                                            <img src="<c:url value="/resources/images/prv/magazine/magazine-small-7.jpg"/>" class="img-responsive" alt="">
                                            <!-- Caption -->
                                            <div class="caption-bottom">
                                                <span class="title c-white">Sometimes the wrong choices bring us to the right places</span>
                                                <span class="subtitle c-white">Laoreet dolore magna aliquam erat are esrseiiqetuer ipisci.</span>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="cta-wr">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1>
                            Buy IMAX/3D movie tickets without waiting in the line!
                            </h1>
                        </div>
                        <div class="col-md-3">
        ...
        <section class="slice light-gray bb">
            <div class="wp-section">
                <div class="container">
                    <div class="section-title-wr">
                        <h3 class="section-title left"><span>Popular Movie</span></h3>
                    </div>
                    <div class="no-margin owl-carousel owl-carousel-4" data-owl-pagination="smth">
                        ...
                        <div class="item">
                            <div class="wp-block product">
                                <figure>
                                    <img alt="" src="<c:url value="/resources/images/prv/product-4.jpg"/>" class="img-responsive img-center">
