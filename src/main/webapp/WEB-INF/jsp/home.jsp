...
<head>
        ...
        <!-- Essential styles -->
       <%--  <style><%@ include file="/resources/assets/bootstrap/css/bootstrap.min.css"%></style>
        <style><%@ include file="/resources/font-awesome/css/font-awesome.min.css"%></style>
        <style>	<%@ include file="/resources/assets/fancybox/jquery.fancybox.css"%></style>
        <style>	<%@ include file="/resources/assets/owl-carousel/owl.carousel.css"%></style>
        <style>
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="HomeServlet" >
                            <tr>
                                <!-- <td><img src="images/ginko-logo.png"></td> -->
                                <td><h1>Apple Movie'Inc</h1></td>
                            </tr>
                        </a>
                    </div>
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                                ...
                                <div class="bg-light-gray">
                                    <form class="form-horizontal form-light p-15" role="form">
                                        <div class="input-group input-group-lg">
                                            <input type="text" class="form-control" placeholder="I want to find ...Moive">
                                            <span class="input-group-btn">
                            ...
                            <li class="dropdown dropdown-meganav mega-dropdown-fluid">
                                <li class="dropdown dropdown-meganav mega-dropdown-fluid">
                                    <a href="HomeServlet" class="dropdown-toggle" data-toggle="dropdown">HOME</a>
                                ...
                                <li class="dropdown">
                                    <a href="signup.html" class="dropdown-toggle" data-toggle="dropdown">SIGN IN</a>
                                    <ul class="dropdown-menu">
        ...
        <section id="slider-wrapper" class="layer-slider-wrapper layer-slider-dynamic">
            <div id="layerslider" style="width:100%;height:520px;">
                ...
                <div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;">
                    ...
                    Apple Movie is the best movie searching engine :)
                    </p>
                            ...
                            <div class="row">
                                <div id="ulSorList" style="margin:15px 15px;">
                                    <div class="mix category_1 mix_all" data-cat="1">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="images/prv/new1.jpg" alt="" class="img-responsive">
                                    ...
                                    <div class="mix category_2 mix_all" data-cat="2">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="images/prv/new2.jpg" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    This movie wins Glammer Prize
                                                    </p>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="mix category_3 mix_all" data-cat="3">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="images/prv/new3.jpg" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Yet this is another awesome movie
                                                    </p>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="mix category_4 mix_all" data-cat="4">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="images/prv/new4.jpg" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Best Movie Ever
                                    ...
                                    <div class="mix category_6 mix_all" data-cat="6">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="images/prv/new6.jpg" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Check it out!
                                    ...
                                    <div class="mix category_7 mix_all" data-cat="7">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="images/prv/new7.jpg" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Watch me Watch me!
                                    ...
                                    <div class="mix category_9 mix_all" data-cat="9">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="images/prv/wk-big-img-1.jpg" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                    ...
                                    <div class="mix category_10 mix_all" data-cat="10">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="images/prv/wk-big-img-2.jpg" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque
                                    ...
                                    <div class="mix category_11 mix_all" data-cat="11">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="images/prv/wk-big-img-3.jpg" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque
                                    ...
                                    <div class="mix category_12 mix_all" data-cat="12">
                                        <div class="wp-block inverse">
                                            <a class="hov {shiftContent:30}" href="#">
                                                <img src="images/prv/wk-big-img-4.jpg" alt="" class="img-responsive">
                                                <div class="caption base">
                                                    <h2 class="title">Film Name</h2>
                                                    <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="wp-block mb-20">
                                            <img src="images/prv/magazine/magazine-small-5.jpg" class="img-responsive" alt="">
                                            <!-- Caption -->
                                            <div class="caption-bottom">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="col">
                            <h4>About me</h4>
                            <p class="no-margin">
                            Spread best movie for audience
                            <br>
