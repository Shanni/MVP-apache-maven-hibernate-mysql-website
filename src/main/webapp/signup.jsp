												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<label class="input"> <i
															...
															placeholder="E-mail" /> <b
															class="tooltip tooltip-bottom-right">enter your email
																address</b>
														</label>
													</div>
												</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="input"> <i
															...
															class="tooltip tooltip-bottom-right">enter your
																password</b>
														</label>
													</div>
												</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label class="input"> <i
															class="icon-append fa fa-lock"></i> <input
															 type="password" name="password_comfirm"
															placeholder="Comfirm Password" /> <b
															class="tooltip tooltip-bottom-right">comfirm your
																password</b>
														</label>
													</div>
												</div>
										...
										<div class="row">
											<div class="col-md-8">
												<label class="checkbox"> <input type="checkbox"
													name="subscription_check" id="subscription"> <i></i> I
													accept the <a href="#">terms and conditions</a> of this
													website.
												</label>
											</div>
											<div class="col-md-4">
											...
											<p>
												Already have an account? <a href="login">Click here to
													sign in.</a>
											</p>
									  </div>
